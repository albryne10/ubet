          ...
          <div className="space-y-10">
            <section>
              <p className="leading-relaxed mb-4">
                SoarBy (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by SoarBy.
              </p>
              <p className="leading-relaxed">
                This Privacy Policy applies to our website, and its associated subdomains (collectively, our “Service”) alongside our application, SoarBy. By accessing or using our Service, you signify that you have read, understood, and agree to our collection, storage, use, and disclosure of your personal information as described in this Privacy Policy and our Terms of Service.
              </p>
            </section>
            <section>
              ...
              <ul className="list-disc pl-6 space-y-3 text-foreground/80">
                ...
                <li><strong>Customer:</strong> refers to the company, organization or person that signs up to use the SoarBy Service to manage the relationships with your consumers or service users.</li>
                ...
                <li><strong>IP address:</strong> Every device connected to the Internet is assigned a number known as a Internet protocol (IP) address. These numbers are usually assigned in geographic blocks. An IP address can often be used to identify the location from which a device is connecting to the Internet.</li>
                <li><strong>Personnel:</strong> refers to those individuals who are employed by SoarBy or are under contract to perform a service on behalf of one of the parties.</li>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4">When does SoarBy use end user information from third parties?</h2>
              <p className="leading-relaxed">
                SoarBy will collect End User Data necessary to provide the SoarBy services to our customers.
              </p>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4">When does SoarBy use customer information from third parties?</h2>
              <p className="leading-relaxed">
                We receive some information from the third parties when you contact us. For example, when you submit your email address to us to show interest in becoming a SoarBy customer, we receive information from a third party that provides automated fraud detection services to SoarBy. We also occasionally collect information that is made publicly available on social media websites. You can control how much of your information social media websites make public by visiting these websites and changing your privacy settings.
              </p>
            </section>
            <section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                SoarBy will collect personal information that you submit to us. We may also receive personal information about you from third parties as described above.
              </p>
            </section>
            <section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                We keep your information only so long as we need it to provide SoarBy to you and fulfill the purposes described in this policy. This is also the case for anyone that we share your information with and who carries out services on our behalf. When we no longer need to use your information and there is no need for us to keep it to comply with our legal or regulatory obligations, we’ll either remove it from our systems or depersonalize it so that we can't identify you.
              </p>
            </section>
            <section>
              ...
              <p className="leading-relaxed mb-4">
                After a transaction, your private information (credit cards, social security numbers, financials, etc.) is never kept on file. We cannot, however, ensure or warrant the absolute security of any information you transmit to SoarBy or guarantee that your information on the Service may not be accessed, disclosed, altered, or destroyed by a breach of any of our physical, technical, or managerial safeguards.
              </p>
            </section>
            <section>
              <h2 className="text-2xl font-semibold mb-4">Could my information be transferred to other countries?</h2>
              <p className="leading-relaxed">
                SoarBy is incorporated in Ireland. Information collected via our website, through direct interactions with you, or from use of our help services may be transferred from time to time to our offices or personnel, or to third parties, located throughout the world, and may be viewed and hosted anywhere in the world, including countries that may not have laws of general applicability regulating the use and transfer of such data. To the fullest extent allowed by applicable law, by using any of the above, you voluntarily consent to the trans-border transfer and hosting of such information.
              </p>
            </section>
            <section>
              <h2 className="text-2xl font-semibold mb-4">Is the information collected through the SoarBy Service secure?</h2>
              <p className="leading-relaxed">
            ...
            <section>
              ...
              <p className="leading-relaxed mb-4">
                The rights you have to request updates or corrections to the information SoarBy collects depend on your relationship with SoarBy. Personnel may update or correct their information as detailed in our internal company employment policies.
              </p>
              <p className="leading-relaxed mb-4">
