        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <section className="space-y-6">
            <p className="text-lg leading-relaxed">
              We're sorry to see you leave. If you've decided to permanently delete your SoarBy account and all associated personal data,
            ...
            <div className="my-10 p-6 bg-muted/50 rounded-lg border border-border">
              ...
              <p className="text-2xl font-bold text-primary text-center mb-6 break-all">
                <a
                  href="mailto:support@soarby.app?subject=Account%20Deletion%20Request"
              ...
              <ul className="list-disc pl-6 space-y-2 text-foreground/90">
                <li>The email address you used to register with SoarBy</li>
                ...
                <li>A clear statement such as: "I request permanent deletion of my SoarBy account and all associated personal data."</li>
              </ul>
            </div>
            <div className="space-y-6">
              ...
              <ul className="list-disc pl-6 space-y-3 text-foreground/80">
                ...
                <li>
                  After deletion, your account, challenges/history (if any), balance (if unused), profile, and all personal information will be <strong>permanently removed</strong> and <strong>cannot be recovered</strong>.
                </li>
              </ul>
            </div>
            ...
            <p className="leading-relaxed mt-12 text-center md:text-left">
              ...
              <a href="mailto:support@soarby.app" className="hover:underline">
                support@soarby.app
              </a>.
            </p>
            <p className="text-center mt-12 pt-8 border-t">
              Thank you for being part of the SoarBy community. We wish you the best.
            </p>
          </section>
        </div>
      </div>
